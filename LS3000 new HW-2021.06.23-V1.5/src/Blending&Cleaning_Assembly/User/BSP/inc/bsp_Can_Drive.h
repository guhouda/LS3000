...
typedef enum
{
	...
	MOTOR_Needle_Y_Move1 = 0x00,    //水平电机
	MOTOR_Needle_Z_Move1 = 0x01,    //垂直电机
	MOTOR_Turntable = 0x02,  //反应盘电机
	MOTOR_Pump_Sample3 = 0x03, //精密泵驱动电机3	
	MOTOR_Cleaning = 0x04, //清洗臂电机
	MOTOR_Wiping = 0x05, //擦拭臂电机	
	#endif	
...
typedef enum
{
	...
	CMD_CLEANALLCUP = 0XAC,  //清理杯子
	CMD_CLEANCUPNUM = 0XAD,  //清理杯子个数修改
}RECEIVE_CMD_TYPE;
...
typedef enum
{
	...
	CLEANALLCUP = 0XAC,  //清理杯子
	CLEANCUPNUM = 0XAD,  //清理杯子个数修改
}SEND_CMD_TYPE;
