...
const MOTOR_REG_PARAM  MOTOR_PARAM_REG[MAX_MOTOR_NUM]=            // 寄存器配置
{
    {	// 1
		...
		#if 1
		.tvalHold = Kval_Perc_to_Par(8),
		.tvalRun  = Kval_Perc_to_Par(16),
		.tvalAcc  = Kval_Perc_to_Par(16),
		.tvalDec  = Kval_Perc_to_Par(16),
    ...
    {	// 2
		...
		.acc      = AccDec_Steps_to_Par(2000), 
		.dec      = AccDec_Steps_to_Par(2000), 
		.maxSpeed = MaxSpd_Steps_to_Par(800), // step/s 
		.minSpeed = MinSpd_Steps_to_Par(0), 
		.fsSpd    = FSSpd_Steps_to_Par(5000), 	
		#if 1
		.tvalHold = Kval_Perc_to_Par(6),
		.tvalRun  = Kval_Perc_to_Par(12),
		.tvalAcc  = Kval_Perc_to_Par(12),
		.tvalDec  = Kval_Perc_to_Par(12),
		.reserver_3 = IntSpd_Steps_to_Par(0),
		.tFast    = BEMF_Slope_Perc_to_Par(0.02), 
		.tonMin   = BEMF_Slope_Perc_to_Par(0.06), 
		.toffMin  = BEMF_Slope_Perc_to_Par(0.06),
    ...
    {	// 3
		...
		.maxSpeed = MaxSpd_Steps_to_Par(600), // step/s 
		.minSpeed = MinSpd_Steps_to_Par(0), 
		.fsSpd    = FSSpd_Steps_to_Par(5000), 	
		#if 1
		.tvalHold = Kval_Perc_to_Par(6),
    ...
    {	// 4
		...
		.acc      = AccDec_Steps_to_Par(3000), 
		.dec      = AccDec_Steps_to_Par(3000), 
		.maxSpeed = MaxSpd_Steps_to_Par(900), // step/s 
		.minSpeed = MinSpd_Steps_to_Par(0), 
		.fsSpd    = FSSpd_Steps_to_Par(5000), 	
		#if 1
		.tvalHold = Kval_Perc_to_Par(2),
		.tvalRun  = Kval_Perc_to_Par(4),
		.tvalAcc  = Kval_Perc_to_Par(4),
		.tvalDec  = Kval_Perc_to_Par(4),
		.reserver_3 = IntSpd_Steps_to_Par(0),
		.tFast    = BEMF_Slope_Perc_to_Par(0.02), 
		...
		.config   = 0x2E83,	
		#endif
		.runspeed = Speed_Steps_to_Par(600),
	}, 
 {	// 5
		.absPos   = 0x00, 
		.elPos    = 0x00, 
  ...
  {	// 6
    ...
    {	// 7
		...
		.fsSpd    = FSSpd_Steps_to_Par(5000), 	
		#if 1
		.tvalHold = Kval_Perc_to_Par(3),
		.tvalRun  = Kval_Perc_to_Par(6),
		.tvalAcc  = Kval_Perc_to_Par(6),
		.tvalDec  = Kval_Perc_to_Par(6),
		.reserver_3 = IntSpd_Steps_to_Par(0),
		.tFast    = BEMF_Slope_Perc_to_Par(0.02), 
		.tonMin   = BEMF_Slope_Perc_to_Par(0.06), 
		.toffMin  = BEMF_Slope_Perc_to_Par(0.06),
