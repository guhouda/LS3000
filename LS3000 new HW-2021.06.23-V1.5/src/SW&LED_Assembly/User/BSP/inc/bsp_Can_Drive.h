...
#define Cartridge_Switch_ID	  0x06
...
typedef enum
{
	...
	CMD_SEND_ITEM = 0x47,                  //发送卡盒扫码结果
	CMD_CHECK_BOX_IO_STATE = 0x48,          //查询卡盒插入状态
	CMD_CHECK_SWITCH_STATE = 0x49,          //查询稀释液开关状态
