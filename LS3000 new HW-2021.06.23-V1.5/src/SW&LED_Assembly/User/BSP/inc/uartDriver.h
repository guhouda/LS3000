...
#define UART_BOX_SCAN1       NO_UART3
#define UART_BOX_SCAN2       NO_UART5
#define UART_BOX_SCAN3       NO_UART6
#define UART_BOX_SCAN4       NO_UART2
#define UART_BOX_SCAN5       NO_UART8
