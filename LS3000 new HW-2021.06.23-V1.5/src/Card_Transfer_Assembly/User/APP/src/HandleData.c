...
{	
		...
		g_MachineParam.MotorMoveStep.M3_Offset_Steps = 500;	
		g_MachineParam.MotorMoveStep.M4_Offset_Steps = 100;	
		g_MachineParam.MotorMoveStep.M5_Offset_Steps = 500;	
		g_MachineParam.MotorMoveStep.M6_Offset_Steps = 500;    
		g_MachineParam.MotorMoveStep.M1_Stripe_X1_Pos = 1000;
		g_MachineParam.MotorMoveStep.M1_Stripe_X2_Pos = 1000+14600;
		g_MachineParam.MotorMoveStep.M1_Stripe_X3_Pos = 1000+14600*2;
		g_MachineParam.MotorMoveStep.M1_Stripe_X4_Pos = 1000+14600*3;
		g_MachineParam.MotorMoveStep.M1_Stripe_X5_Pos = 1000+14600*4;
		g_MachineParam.MotorMoveStep.M2_Work_Pos = 0;
		g_MachineParam.MotorMoveStep.M2_Start_Pos = 100000; 	
		g_MachineParam.MotorMoveStep.M2_End_Pos = 0;    
		g_MachineParam.MotorMoveStep.M3_Stripe_X1_Pos = 1900;
		g_MachineParam.MotorMoveStep.M3_Stripe_X2_Pos = 1900+14600;
		g_MachineParam.MotorMoveStep.M3_Stripe_X3_Pos = 1900+14600*2;
		g_MachineParam.MotorMoveStep.M3_Stripe_X4_Pos = 1900+14600*3;
		g_MachineParam.MotorMoveStep.M3_Stripe_X5_Pos = 1900+14600*4;    
		g_MachineParam.MotorMoveStep.M3_Stripe_Convey1_Pos = 63000;
		g_MachineParam.MotorMoveStep.M4_Stripe_realignment_Pos = 6400;
		g_MachineParam.MotorMoveStep.M5_Stripe_Convey2_Pos = 550;
		g_MachineParam.MotorMoveStep.M5_Stripe_In_Pos = 63500;
		g_MachineParam.MotorMoveStep.M5_back_Pos = 1500;
		g_MachineParam.MotorMoveStep.M6_Blend_Pos = 34400;
