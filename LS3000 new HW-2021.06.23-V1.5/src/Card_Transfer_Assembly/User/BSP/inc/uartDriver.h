...
#define UART_CARD_SCAN       NO_UART2
#define UART_BOX_SCAN1       NO_UART4
#define UART_BOX_SCAN2       NO_UART7
#define UART_BOX_SCAN3       NO_UART5
#define UART_BOX_SCAN4       NO_UART3
#define UART_BOX_SCAN5       NO_UART6
